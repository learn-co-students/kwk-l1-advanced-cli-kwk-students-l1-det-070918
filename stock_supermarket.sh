...
mv delivery/fage.yogurt.txt dairy;
mv delivery/fig_bar.txt snax;
...
mv delivery/lean_cuisine.txt meat;
...
mv delivery/watermelon fruit;
mv delivery/whole_chicken meat;
mv delivery/wonder_bread.txt snack;